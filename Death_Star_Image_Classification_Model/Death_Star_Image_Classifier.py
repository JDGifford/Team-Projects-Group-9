...
print("Accuracy of Logistic Regression with Adaboost is: ", accuracy_score(y_test, y_predict))
print("Precision of Logistic Regression with Adaboost is: ", precision_score(y_test, y_predict))
print("Recall of Logistic Regression with Adaboost is: ", recall_score(y_test, y_predict))
print("F1-Score of Logistic Regression with Adaboost is: ", f1_score(y_test, y_predict))